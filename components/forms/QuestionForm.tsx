...
const QuestionForm = () => {
    ...
    const handleinputKeyDown = (e: React.KeyboardEvent<HTMLInputElement>, field: { value: string[] }) => {
        if (e.key === 'Enter') {
            ...
            if (value && field.value.length < 15 && !field.value.includes(value)) {
        ...
        <Form {...form}>
            <form className='flex w-full flex-col gap-10' onSubmit={form.handleSubmit(handleCreateQuestion)}>
                ...
                <FormField
                    ...
                    render={({ field }) => (
                        <FormItem className='flex w-full flex-col gap-3'>
                            ...
                            <FormDescription className='body-regular text-light-500 mt-2.5'>
                                Add up tp 3 tags to descripbe what your question is about. You need to press enter to add a tag.
                            </FormDescription>
                            <FormMessage />
                        </FormItem>
                    )}
                ...
                <div className='mt-16 flex justify-end'>
                    <Button type="submit" className='primary-gradient w-fit !text-light-900'>Ask A Question</Button>
                </div>
            </form>
        </Form>
    )
